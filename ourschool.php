        ...
        <div class="container_12">
            <div class="grid_8">
                ...
                <div class="extra_wrapper">
                    <p class="p1 col1"><a href="#">Το 1922 το πρώτο σχολείο στεγάστηκε σε σπίτι ανταλλάξιμο το οποίο
                            παραχωρήθηκε στη σχολική εφορεία μαζί με γήπεδο 2.400 τ.μ. Το διδακτήριο κτίστηκε το 1929 σε
                            γήπεδο 7.016 τ.μ. (116Χ60 περίπου) και ήταν 2/θέσιο με έκταση 182 τ.μ.</a></p>
                </div>
                <div class="clear"></div>
