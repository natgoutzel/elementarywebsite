...
<body>
	...
	<div class="main">
		<div class="header" >
			<h1>Συνδεθείτε ή Δημιουργήστε Νέο Λογαριασμό!</h1>
		</div>
		<p>Αν είστε χρήστες μπορείτε να ανεβάζεται διάφορες ανακοινώσεις και να κοινοποιείτε διάφορες εκδηλωσεις του σχολείου </p>
			<form>
				...
				<ul class="left-form">
					...
					<li>
						...
						<div class="clear"> </div>
                                        ...
                                        <li>
						<input type="password"   placeholder="administrator password" required/>
						<a href="#" class="icon into"> </a>
						<div class="clear"> </div>
					</li> 
					<label class="checkbox"><input type="checkbox" name="Δικαιώματα διαχειριστή" checked=""><i> </i>Δικαιώματα διαχειριστη, έχει μόνο ένας χρήστης</label>
