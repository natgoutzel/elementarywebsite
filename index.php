    ...
    <div class="content">
        ...
        <div class="container_12">
            ...
            <div class="grid_4">
                ...
                <p>Θα μείνουμε ευχαριστημένοι αν η περιήγησή σας στον ιστοτοπό μας, έχει να σας προσφέρει οτιδήποτε
                    επιμορφωτικό, πληροφοριακό ή ψυχαγωγικό.</p>
            </div>
            <div class="clear"></div>
            ...
            <div class="container_12">
                <div class="grid_8">
                    ...
                    <ul class="list">
                        ...
                        $sql = "SELECT post_title, post_id FROM post ORDER BY post_id DESC LIMIT 5";

                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo('<li><a href="single_post_page.php?id='.$row['post_id'].' ">' . $row['post_title'] . '</a></li>');
                            }
                        } else {
                ...
                <div class="grid_4 ">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="http://kmaked.pde.sch.gr/site/index.php/paratiritirio-bias/paratiritirio-bias-3">παρατηρητηριο
                                βιας κεντρικης μακεδονιας</a></li>
            ...
            <div class="grid_7 prefix_1">
                ...
                <div class="extra_wrapper">
                    <p>Το σχολείο μας στεγάζεται στο Σκούταρι Σερρών. Πατήστε παρακάτω για πλοήγηση στο χάρτη <span
                            class="col1"><a href=" http://blog.templatemonster.com/free-website-templates/"
                                            rel="dofollow">εδώ</a></span>.</p>
